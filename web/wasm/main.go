...
func jsonFunc(fn func(args []js.Value) ([]byte, error)) js.Func {
...
func main() {
	js.Global().Set("siftLoadScenario", jsonFunc(func(a []js.Value) ([]byte, error) {
		return engine.LoadScenario([]byte(a[0].String()))
	}))
	js.Global().Set("siftRun", jsonFunc(func(a []js.Value) ([]byte, error) {
		return engine.Run([]byte(a[0].String()), []byte(a[1].String()))
	}))
	js.Global().Set("siftExplain", jsonFunc(func(a []js.Value) ([]byte, error) {
